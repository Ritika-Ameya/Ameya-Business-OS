...
export function DashboardGreeting() {
  return (
    <div className="relative overflow-hidden rounded-2xl border border-white/60 bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-700 p-4 text-white shadow-elevated sm:p-6 lg:p-8 dark:border-white/10">
      <div
