...
import { ExpenseMasterTab } from "@/features/expenses/components/ExpenseMasterTab";
import { ExpenseRegisterTab } from "@/features/expenses/components/ExpenseRegisterTab";
...
export function ExpensesPage() {
  ...
  const effectiveRegisterDialogOpen = registerDialogOpen || openAddDialog;
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="gap-6">
        ...
        <TabsContent value="register" className="mt-0">
          <ExpenseRegisterTab
            ...
            dialogOpen={effectiveRegisterDialogOpen}
